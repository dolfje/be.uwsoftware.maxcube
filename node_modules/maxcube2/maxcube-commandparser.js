...
function decodeDevice (payload) {
  ...
  console.log("Device type: "+payload[0]);

  // Check Length of payload and determine what device is encoded.
  switch (payload[0]) {
    // Window switches or shutter contacts have only 6 items.
    case 6: deviceStatus = decodeDeviceWindowSwitch (payload); break;
    // Push buttons.
    case 8: break;
    // Thermostats have only 11 items.
    case 11: deviceStatus = decodeDeviceThermostat (payload); break;
    // Thermostats have 12 items.
    case 12: deviceStatus = decodeDeviceWallThermostat (payload); break;
  }
